...
export function getAppConfig(): AppConfig {
	...
	const encryptConcurrencyEnv = Number(
		process.env.STORAGE_ENCRYPT_CONCURRENCY
	);
	const encryptConcurrency =
		Number.isFinite(encryptConcurrencyEnv) && encryptConcurrencyEnv > 0
